...
import { Eye, EyeOff, Mail, Lock, User, GraduationCap, School, ArrowRight, BookOpen, Target, TrendingUp, Download } from 'lucide-react';
      ...
      <div className="h-full w-full overflow-y-auto">
        <div className="min-h-full flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="white-card rounded-2xl overflow-hidden flex flex-col lg:flex-row w-full max-w-4xl shadow-2xl relative z-10"
          >
            ...
            <div className="lg:w-1/2 bg-gradient-to-br from-blue-50 to-slate-50 p-8 lg:p-12 flex flex-col items-center justify-center relative">
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-gray-800 mb-3">Edunize</h2>
                ...
                >
                  <p className="text-sm text-gray-400 mb-4 text-center">Available for Android</p>
                  <a
                    href="https://edunize.en.aptoide.com/app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-4 px-6 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-2xl font-bold transition-all group border border-gray-100 shadow-sm hover:shadow-md"
                  >
