        ...
        <div className="h-full flex flex-col max-w-7xl mx-auto md:gap-4 md:flex-row">
            ...
            <div className="flex flex-col flex-1 min-w-0 h-full">
                ...
                <div className={`flex-1 ${themeConfig.card} rounded-xl shadow-sm border dark:border-gray-700 overflow-hidden flex flex-col min-h-0 md:mb-6`}>
                    <div className="flex-1 overflow-y-auto p-4 md:p-8 pb-[180px] md:pb-8 space-y-6">
                    ...
                    {/* Input Area */}
                    <div className={`fixed bottom-[100px] left-0 right-0 md:static md:bottom-auto md:p-4 z-[40] bg-transparent md:bg-gradient-to-t ${theme === 'dark' ? 'md:from-gray-900 md:via-gray-900/95 md:to-transparent' : 'md:from-gray-50 md:via-gray-50/95 md:to-transparent'} pointer-events-none`}>
